    ...
    return GestureDetector(
      ...
      child: Stack(
        ...
        children: [
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        Text('${product.price.toString()}'r'$',style: TextStyle(color: Colors.black,fontSize: 16),),
          ...
          Positioned(right: 32,top: -60,child: Image.network(product.image,height: 100,width: 100,)),
        ],
      ),
    );
  }
